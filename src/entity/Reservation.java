...
public class Reservation {
    ...
    public Reservation(int id, int room_id, LocalDate check_in_date, LocalDate check_out_date, double total_price, int guest_count, String guest_name, String guest_citizen_id, String guest_mail, String guest_phone) {
        this.id = id;
        this.room = new Room();
